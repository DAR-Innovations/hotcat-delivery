...
const MasterCardColored = ({ className, filledColor }: IIconProps) => {
  return (
    <svg
    ...
    >
      <g>
        <g>
          <g>
            <circle cx="10" cy="10" fill={filledColor || "#F93232"} r="10" />
            <path
...
export default MasterCardColored;
