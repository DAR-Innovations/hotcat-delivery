      ...
      <main className="mt-10 sm:mt-20 flex flex-col gap-y-12 sm:gap-y-20 lg:gap-y-24 mb-30">
        <div className="flex flex-col items-center gap-5 sm:gap-8 lg:gap-10">
          ...
          <div className="flex items-center gap-x-3 sm:gap-x-7 lg:gap-x-16">
            <div className="bg-[#E2EEF5] p-6 rounded-xl flex flex-col items-center justify-center gap-y-6 w-[110px] h-[160px] sm:min-w-[160px] sm:max-w-[160px] sm:h-[160px] lg:w-[190px] lg:h-[190px]">
            ...
            <div className="bg-[#E2EEF5] p-6 rounded-xl flex flex-col items-center justify-center gap-y-4  w-[110px] h-[160px] sm:min-w-[160px] sm:max-w-[160px] sm:h-[160px] lg:w-[190px] lg:h-[190px]">
              <DeliveryCarOutline className="w-16 h-16" />
              <p className="text-sm sm:text-base text-center text-gray-700">
                Different delivery <br /> services
              </p>
            </div>
            <div className="bg-[#E2EEF5] p-6 rounded-xl flex flex-col items-center justify-center gap-y-5  w-[110px] h-[160px] sm:min-w-[160px] sm:max-w-[160px] sm:h-[160px] lg:w-[190px] lg:h-[190px]">
